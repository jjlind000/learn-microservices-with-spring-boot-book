...
public class AMQPConfiguration {
    @Bean
    // renamed from challengesTopicExchange
    public TopicExchange challengeAttemptTopicExchange(@Value("${amqp.exchange.attempts}") final String exchangeName) {
    ...
    @Bean
    public MessageHandlerMethodFactory jacksonJsonMessageHandlerMethodFactory() {
